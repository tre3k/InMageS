...
#include <memory>
#include "../../src/widgets/centralwidget.h"
...
QT_MOC_LITERAL(3, 24, 6), // "addTab"
QT_MOC_LITERAL(4, 31, 12), // "SideBarUnit*"
QT_MOC_LITERAL(5, 44, 6), // "sbUnit"
QT_MOC_LITERAL(6, 51, 8), // "QWidget*"
QT_MOC_LITERAL(7, 60, 6), // "widget"
QT_MOC_LITERAL(8, 67, 13), // "slot_activate"
QT_MOC_LITERAL(9, 81, 5), // "index"
QT_MOC_LITERAL(10, 87, 8) // "addSplit"

    },
    "CentralWidget\0selected\0\0addTab\0"
    "SideBarUnit*\0sbUnit\0QWidget*\0widget\0"
    "slot_activate\0index\0addSplit"
};
...
void CentralWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addTab((*reinterpret_cast< SideBarUnit*(*)>(_a[1])),(*reinterpret_cast< QWidget*(*)>(_a[2]))); break;
        case 2: _t->slot_activate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->addSplit(); break;
        default: ;
        }
        ...
        {
            using _t = void (CentralWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CentralWidget::selected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CentralWidget::selected(int _t1)
{
